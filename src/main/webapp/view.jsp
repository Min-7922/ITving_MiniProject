	...
	<c:set var="memberdto" value="${memberDAO.selectOne(dto.writer) }" />
			...
			<div>
				<form method="POST" class="replyWrite">
					...
					<div class="sb">
						<div><textarea class="replyBox" name="content" rows="3" cols="145" required></textarea></div>
		...
		<c:forEach var="dto" items="${list }">
			<div class="replyContent sb">
				<div>
					<pre style="font-size: 20px; font-weight: bolder; font-family: sans-serif;">${dto.writer}</pre>
					<pre>${dto.content }</pre>
				</div>
				<div>
